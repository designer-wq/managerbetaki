                    ...
                    <>
                        ...
                        <div className="mb-8 w-full">
                            <div className="rounded-xl border border-zinc-700 bg-zinc-900 p-4 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm relative overflow-visible z-20">
                                ...
                                {/* Right: Action Button removed in edit mode (auto-save enabled) */}
                            ...
                            <div className="flex-1 flex flex-col gap-8">
                                ...
                                <div>
                                    ...
                                    <label className="flex flex-col w-full">
                                        ...
                                        <div className="relative">
                                            <textarea ref={descriptionRef} defaultValue={initialData?.description} onChange={(e) => autoSaveField('description', e.target.value, true)} className="w-full min-h-[160px] rounded-lg text-white focus:outline-0 focus:ring-1 focus:ring-primary border border-zinc-600 bg-zinc-900 placeholder:text-zinc-500 p-4 text-sm resize-y focus:border-primary" placeholder="Descreva os requisitos, copy e instruções específicas para esta demanda..."></textarea>
                                        </div>
                                    </label>
                                </div>
