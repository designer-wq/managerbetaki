                            ...
                            <div className="w-full flex flex-col gap-8">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <label className="flex flex-col w-full col-span-1 md:col-span-2">
                                            <p className="text-white text-sm font-medium leading-normal pb-2 flex items-center justify-between">
                                                <span>Título da Demanda <span className="text-red-400">*</span></span>
                                                {demandIdCode && <span className="text-zinc-500 font-mono text-xs">{demandIdCode}</span>}
                                            </p>
                                            <input ref={titleRef} defaultValue={initialData?.title} onChange={(e) => autoSaveField('title', e.target.value, true)} className="w-full h-11 rounded-[6px] text-white focus:outline-0 focus:ring-1 focus:ring-primary border border-zinc-600 bg-zinc-900/50 placeholder:text-zinc-500 px-4 text-sm transition-all focus:border-primary" placeholder="ex: Campanha Black Friday 2024" />
                                        </label>
                                        ...
                                        <label className="flex flex-col w-full">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input ref={refLinkRef} defaultValue={initialData?.reference_link} onChange={(e) => autoSaveField('reference_link', e.target.value, true)} className="w-full h-11 rounded-[6px] text-white focus:outline-0 focus:ring-1 focus:ring-primary border border-zinc-600 bg-zinc-900/50 placeholder:text-zinc-500 pl-10 pr-4 text-sm transition-all focus:border-primary" placeholder="Cole a URL aqui..." />
                                            </div>
                                        </label>

                                        {/* Drive Link (Moved here) */}
                                        <label className="flex flex-col w-full">
                                            <div className="flex items-center justify-between pb-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input value={driveLink} onChange={(e) => { setDriveLink(e.target.value); autoSaveField('drive_link', e.target.value); }} className="w-full h-11 rounded-[6px] text-white focus:outline-0 focus:ring-1 focus:ring-primary border border-zinc-600 bg-zinc-900/50 placeholder:text-zinc-500 pl-10 pr-4 text-sm transition-all focus:border-primary" placeholder="Cole o link do Google Drive..." />
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <label className="flex flex-col w-full">
                                            ...
                                            <div className="relative">
                                                <select ref={priorityRef} defaultValue={initialData?.priority || "Média"} onChange={(e) => autoSaveField('priority', e.target.value)} className="w-full h-11 rounded-[6px] text-white focus:outline-0 focus:ring-1 focus:ring-primary border border-zinc-600 bg-zinc-900/50 px-4 text-sm appearance-none cursor-pointer focus:border-primary">
                                        ...
                                        <label className="flex flex-col w-full">
                                            ...
                                            <div className="relative">
                                                <select ref={designerRef} defaultValue={initialData?.responsible_id || ""} onChange={(e) => autoSaveField('responsible_id', e.target.value || null)} className="w-full h-11 rounded-[6px] text-white focus:outline-0 focus:ring-1 focus:ring-primary border border-zinc-600 bg-zinc-900/50 px-4 text-sm appearance-none cursor-pointer focus:border-primary">
                                ...
                                <div>
                                    ...
                                    <div className="w-full flex flex-col gap-6">
                                        <label className="flex flex-col w-full">
                                            ...
                                            <div className="relative flex flex-col">
                                                ...
                                                <textarea ref={descriptionRef} defaultValue={initialData?.description} onChange={(e) => autoSaveField('description', e.target.value, true)} className="w-full min-h-[160px] rounded-b-lg rounded-t-none text-white focus:outline-0 focus:ring-1 focus:ring-primary border border-zinc-600 bg-zinc-900 placeholder:text-zinc-500 p-4 text-sm resize-y focus:border-primary" placeholder="Descreva os requisitos, copy e instruções específicas para esta demanda..."></textarea>
                                            </div>
                                        </label>

                                        {/* Grid for Caption and Comments */}
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            {/* Caption */}
                                            <label className="flex flex-col w-full h-[500px]">
                                                <p className="text-white text-sm font-medium leading-normal pb-2">Legenda (Instagram)</p>
                                                <div className="relative flex flex-col h-full">
                                                    ...
                                                    <textarea ref={captionRef} defaultValue={initialData?.caption} onChange={(e) => autoSaveField('caption', e.target.value, true)} className="w-full flex-1 rounded-b-lg rounded-t-none text-white focus:outline-0 focus:ring-1 focus:ring-primary border border-zinc-600 bg-zinc-900 placeholder:text-zinc-500 p-4 text-sm resize-none focus:border-primary" placeholder="Escreva a legenda aqui..."></textarea>
                                                </div>
                                            </label>

                                            {/* Comments (Enhanced Component) */}
                                            <div className="bg-zinc-900/50 rounded-xl p-5 border border-zinc-700/50 flex flex-col h-[500px]">
                                                <DemandComments
                                    ...
                                    <div className="flex gap-2">
                                        <input
                                            value={driveLink}
                                            onChange={(e) => { setDriveLink(e.target.value); autoSaveField('drive_link', e.target.value, true); }}
